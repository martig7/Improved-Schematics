...
const SIGNATURES: Array<{ schema: GeoSchema; water: string[]; collect: string[]; requireAny: string[]; place: string[] }> = [
  ...
  { schema: 'subwaybuilder', water: ['water', 'ocean_foundations'], collect: ['parks', 'landuse'], requireAny: ['parks', 'ocean_foundations'], place: ['city_labels', 'suburb_labels', 'neighborhood_labels'] },
