...
import { STATION_WIDTH, LABEL_FONT_SIZE, LABEL_CHAR_WIDTH, LABEL_OFFSET, LABEL_WRAP_W, MARK_R0, onRenderScale } from './constants';
...
let ANCHOR_SLID_DIST = STATION_WIDTH * 3;
onRenderScale(() => { ANCHOR_SLID_DIST = STATION_WIDTH * 3; });
