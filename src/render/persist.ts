...
// Just the precompute (Maps + unproject samples), for auto-persistence where the
// heavy layout is stored under its own key and the small settings/areas separately
// — so an area edit doesn't re-serialize the ~MB layout.
