// Probe: which NYC routes have reconstructed line traversals in the support
// graph (lines without traversals "connect everywhere" in untangle scoring).
...
for (const r of routes) {
  ...
  const t = h.lineTraversals.get(r.id);
  console.log(r.bullet, t ? t.length + ' steps' : 'NO TRAVERSAL');
}
